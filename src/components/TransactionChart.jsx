...
// Custom legend content to hide labels
			...
			<div className="mt-3 w-full flex-1 text-xs">
				<ResponsiveContainer width="100%" height="100%">
					...
					>
						...
						<Tooltip />
						<Legend
							content={<CustomLegend />} // Custom legend content to hide the legend
							layout="horizontal"
							align="center"
							verticalAlign="top"
							wrapperStyle={{ paddingBottom: 20 }}
						/>
						<Bar dataKey="Expense" fill="#6c5ce7" /> {/* Purple color for Expense */}
						<Bar dataKey="Income" fill="#6c5ce7" />  {/* Purple color for Income */}
					</BarChart>
				</ResponsiveContainer>
			</div>
		</div>
